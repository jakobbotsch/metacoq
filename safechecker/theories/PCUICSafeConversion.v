...
Section Conversion.
  ...
  *)
  ...
  Equations (noeqns) isconv_context_aux
    ...
    isconv_context_aux Γ Γ' Δ Δ' cc check
      ...
      | Success conv_rest
        ...
        | exist false neq_binders => no (todo "error");
    ...
    isconv_context_aux Γ Γ' Δ Δ' cc check Δpre Δ'pre Δpost Δ'post eq eq' => no (todo "error")
    }.
  Next Obligation.
  ...
  Equations (noeqns) isconv_predicate_params_aux
    ...
    isconv_predicate_params_aux
      Γ ci1 p1 c1 brs1 π1 h1 ci2 p2 c2 brs2 π2 h2 hx aux
      pre1 pre2 post1 post2 eq eq2 => no (todo "error").
  Next Obligation.
    constructor; constructor.
  Qed.
  Next Obligation.
  ...
  Equations (noeqns) isconv_predicate
    ...
    isconv_predicate Γ ci1 p1 c1 brs1 π1 h1 ci2 p2 c2 brs2 π2 h2 hx aux
      ...
      | Success conv_params
        ...
        | exist false not_eq_insts => no (todo "error");
